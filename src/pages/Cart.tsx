...
import {cartSelector, clearItem} from '../redux/reducers/cartSlice';
...
const Cart: FC = () => {
    ...
    const totalCountPizzas = items.reduce((prevItem, currentItem) => prevItem + currentItem.count, 0)
            ...
            <div className="cart">
                ...
                <div className="cart__bottom">
                    <div className="cart__bottom-details">
                        <span> Всего пицц: <b>{totalCountPizzas} шт.</b> </span>
