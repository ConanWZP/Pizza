...
import {typePizzaObject} from "../PizzaBlock/PizzaBlock";
import {useAppDispatch} from "../../hooks";
import {addItem, minusPizza, removeItem} from "../../redux/reducers/cartSlice";

interface extraTypesCartItem {
    count: number
}


const CartItem: FC<typePizzaObject & extraTypesCartItem > = ({type, imageUrl, title, size, id, price, count}) => {
